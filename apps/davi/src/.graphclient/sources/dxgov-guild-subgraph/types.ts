...
export type _SubgraphErrorPolicy_ =
  ...
  /** null **/
  proposalStateLog: InContextSdkMethod<Query['proposalStateLog'], QueryproposalStateLogArgs, MeshContext>,
  /** null **/
  proposalStateLogs: InContextSdkMethod<Query['proposalStateLogs'], QueryproposalStateLogsArgs, MeshContext>,
  /** null **/
  ...
  /** null **/
  guildPermission: InContextSdkMethod<Query['guildPermission'], QueryguildPermissionArgs, MeshContext>,
  /** null **/
  guildPermissions: InContextSdkMethod<Query['guildPermissions'], QueryguildPermissionsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  ...
  /** null **/
  proposalStateLog: InContextSdkMethod<Subscription['proposalStateLog'], SubscriptionproposalStateLogArgs, MeshContext>,
  /** null **/
  proposalStateLogs: InContextSdkMethod<Subscription['proposalStateLogs'], SubscriptionproposalStateLogsArgs, MeshContext>,
  /** null **/
  ...
  /** null **/
  guild: InContextSdkMethod<Subscription['guild'], SubscriptionguildArgs, MeshContext>,
  /** null **/
  guilds: InContextSdkMethod<Subscription['guilds'], SubscriptionguildsArgs, MeshContext>,
  /** null **/
  token: InContextSdkMethod<Subscription['token'], SubscriptiontokenArgs, MeshContext>,
  /** null **/
  tokens: InContextSdkMethod<Subscription['tokens'], SubscriptiontokensArgs, MeshContext>,
  /** null **/
  guildPermission: InContextSdkMethod<Subscription['guildPermission'], SubscriptionguildPermissionArgs, MeshContext>,
  /** null **/
  guildPermissions: InContextSdkMethod<Subscription['guildPermissions'], SubscriptionguildPermissionsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  _meta: InContextSdkMethod<Subscription['_meta'], Subscription_metaArgs, MeshContext>
  };

  export type Context = {
      ["dxgov-guild-subgraph"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
